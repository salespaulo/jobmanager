...
class XmlSchedulerRepository implements SchedulerRepository {
	...
	/* (non-Javadoc)
	 * @see br.com.certisign.jobmanager.core.SchedulerRepository#get()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.certisign.jobmanager.core.SchedulerRepository#clear()
	 */
	@Override
	public void clear() {
	...
	/* (non-Javadoc)
	 * @see br.com.certisign.jobmanager.core.SchedulerRepository#refresh()
	 */
	@Override
	public void refresh() {
		this.loadFromXml();
	...
	/* (non-Javadoc)
	 * @see br.com.certisign.jobmanager.core.SchedulerRepository#add(br.com.certisign.jobmanager.core.SchedulerContexts)
	 */
	@Override
